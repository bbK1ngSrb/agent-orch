...
Run two local coding agents (Claude, Codex, Copilot, Gemini) in a cross-audit loop on any git repo.
...
## Requirements
- Node ≥ 18
- At least one agent CLI installed: `claude`, `codex`, `copilot`, `gemini`, or `ccr` (for
