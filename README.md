...
- `orch agent add <name> [--build]` — append a registered agent to `.orch/orch.yml`, or scaffold an unregistered adapter through orch's own author → audit → test pipeline. Set `merge: pr` to open a PR.
