...
export const OPTION_CATALOG = [
  ...
  { keys: ["reviseCap"], label: "revise cap", widget: NUMBER, min: 1, explain: "Maximum review rounds including the first (author revisions = this minus one) before escalation. Higher values spend more time trying to self-heal; lower values fail faster." },
