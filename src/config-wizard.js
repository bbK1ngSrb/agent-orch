...
export const OPTION_CATALOG = [
  ...
  { keys: ["roundCap"], label: "round cap", widget: NUMBER, min: 1, explain: "Maximum review rounds before escalation, counting the initial review as round one — 3 means 3 reviews and 2 repair rounds. Higher values spend more time trying to self-heal; lower values fail faster. (reviseCap is the deprecated alias.)" },
