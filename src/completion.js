...
_orch_completion() {
  ...
  local flags="-h --help --version --author --authors --reviewer --reviewers --cheap --config-file --dry --check --link --no-banner --no-tidy --json --limit --check-history --once --plain --refresh-ms --merge --pr"
