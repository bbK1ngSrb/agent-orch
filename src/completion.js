...
_orch_completion() {
  ...
  local flags="-h --help --version --author --authors --reviewer --reviewers --cheap --config-file --dry --check --link --no-banner --no-tidy --json --once --plain --limit --refresh-ms --check-history --merge --pr"
