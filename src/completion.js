...
_orch_completion() {
  ...
  local commands="init agent task issue review pr continue dashboard upgrade update completion version help"
  local flags="-h --help --version --author --authors --reviewer --reviewers --cheap --config-file --allow-protected --dry --check --link --no-banner --no-tidy --json --limit --check-history --once --plain --refresh-ms --merge --pr"
