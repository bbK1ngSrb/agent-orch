...
export function register(orchDir, sid, { branch, pid, baseSha, closes = null, author = null, reviewers = null, workOrder = null, excludedAgents = [], rotationStage = null, detached = false, log = null, runId = null }) {
  writeRecord(dir(orchDir), sid, {
    sid, branch, pid, baseSha, closes, author, reviewers, workOrder, excludedAgents, rotationStage, paths: [],
    ...(detached ? { detached: true, log, runId: runId || sid } : {}),
  });
}
