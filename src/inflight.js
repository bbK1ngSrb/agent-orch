...
export function register(orchDir, sid, { branch, pid, baseSha, closes = null, author = null, reviewers = null, workOrder = null, excludedAgents = [] }) {
  writeRecord(dir(orchDir), sid, { sid, branch, pid, baseSha, closes, author, reviewers, workOrder, excludedAgents, paths: [] });
}
...
export function setRoles(orchDir, sid, { author, reviewers, excludedAgents } = {}) {
  const d = dir(orchDir);
  try {
